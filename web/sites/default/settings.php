 ...
 * @endcode
 */
$settings['hash_salt'] = 'kBNCIH-q58ZoilL0YpdkRKhqYTn9VxM4ZpqdB0nqrR86BLf0oOtiMdo31wekDDBqGiOpHXYSgg';
...
$settings['config_sync_directory'] = 'sites/default/files/config_19j27XR4WSYmj1ffFBnAHQ9dJJMEtXX3h4vzEeJ4VjTnBqaVJXWlsYgRq-zXN0fKhIkFjqihhg/sync';

// Kint max depth level setting
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_v7_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_v7_dd.inc';
}
// </DDSETTINGS>
